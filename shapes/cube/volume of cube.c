...
int main (void)
{
    ...
    printf ("enter width then hit enter then enter height then enter then enter length to find volume of a cube \n");
    ...
    float product = rect1.height * rect1.width * rect1.length;
    printf ("%.2f\n",product);
}
